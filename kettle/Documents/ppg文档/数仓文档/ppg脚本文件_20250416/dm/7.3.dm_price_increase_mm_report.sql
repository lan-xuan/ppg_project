-- 20240902:修改price impact逻辑与vpm保持一致 -- 该问题只影响到24年1月（23年1月同期）
...
where 1=1
-- 	and sales_month= '202401'
	and substr(sales_month,1,6)  = ${mysql_yesterday_l_month}
...
where 1=1
	and substr(sales_month,1,6)  = ${mysql_yesterday_l_month_l_year}
	and channel <> 'DISTRIBUTOR'
-- 	 and  customer_code = '125640'
-- and item_code = 'P190-6060.JLR/5L-C3'
-- and proj_name_en = 'JLR'
...
SELECT sales_year,sales_month,customer_code,customer_name,item_code,item_code_ppg,category,category_brand,category_product_type,channel,proj_name,proj_name_en,
...
,'Impact' as sec_1,'Price Increase' as sec_2,CONCAT('FY',substr(sales_year,3,2),' ',sales_month_en) as sec_3,'是' as is_flag FROM aa
